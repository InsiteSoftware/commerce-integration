...
[DependencyName(nameof(SXeVersion.Ten))]
internal sealed class IntegrationConnectorServiceSXeV10 : IIntegrationConnectorServiceSXe
{
    private readonly IPipeAssemblyFactory pipeAssemblyFactory;

    public IntegrationConnectorServiceSXeV10(IPipeAssemblyFactory pipeAssemblyFactory)
    {
    ...
    {
        var getOEPricingMultipleV4Parameter = new OEPricingMultipleV4Parameter()
        {
            GetInventoryParameter = getInventoryParameter,
            IntegrationConnection = integrationConnection
        };

        var getOEPricingMultipleV4Result = this.pipeAssemblyFactory.ExecutePipeline(
            getOEPricingMultipleV4Parameter,
            new OEPricingMultipleV4Result()
        );

        return getOEPricingMultipleV4Result.GetInventoryResult;
    }
    ...
    )
    {
        ...
        return getOEPricingMultipleV4Result.PricingServiceResults;
    }
}
