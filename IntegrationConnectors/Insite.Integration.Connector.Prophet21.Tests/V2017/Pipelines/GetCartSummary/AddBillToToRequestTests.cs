    ...
    : BaseForPipeTests<GetCartSummaryParameter, GetCartSummaryResult>
{
    ...
    [Test]
    public void Execute_Should_Populate_GetCartSummaryRequest_Request_CustomerCode_With_Customer_ErpNumber()
    {
        ...
        Assert.AreEqual(
            ...
            result.GetCartSummaryRequest.Request.CustomerCode
        );
    }

    [Test]
    public void Execute_Should_Populate_GetCartSummaryRequest_Request_CustomerCode_With_Guest_Customer_ErpNumber()
    {
        ...
        Assert.AreEqual(guestCustomer.ErpNumber, result.GetCartSummaryRequest.Request.CustomerCode);
    }

    [Test]
    public void Execute_Should__Not_Populate_GetCartSummaryRequest_Request_CustomerCode_When_Customer_Order_Customer_And_Guest_Customer_ErpNumbers_Are_Null_Or_Empty()
    {
        var customerOrder = Some.CustomerOrder().With(Some.Customer()).Build();
        ...
        Assert.That(result.GetCartSummaryRequest.Request.CustomerCode, Is.Null.Or.Empty);
    }
