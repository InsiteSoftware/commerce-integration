...
[TestFixture]
public class APlusApiServiceFactoryTests
{
    private APlusApiServiceFactory aPlusApiServiceFactory;
    ...
    public void SetUp()
    {
        ...
        this.aPlusApiServiceFactory = container.Resolve<APlusApiServiceFactory>();
    }
    ...
    )
    {
        try
        {
            return (IntegrationConnection)
                typeof(APlusApiServiceFactory)
                    .GetMethod(
                        "GetIntegrationConnection",
                        BindingFlags.NonPublic | BindingFlags.Instance
                    )
                    .Invoke(this.aPlusApiServiceFactory, new object[] { integrationConnection });
        }
    ...
    protected void WhenConnectionId(string connectionId)
    {
        this.integrationConnectorSettings
            .Setup(o => o.APlusIntegrationConnectionId)
