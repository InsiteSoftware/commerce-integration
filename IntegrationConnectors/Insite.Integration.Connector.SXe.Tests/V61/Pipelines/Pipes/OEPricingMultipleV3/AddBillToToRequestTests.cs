    ...
    : BaseForPipeTests<OEPricingMultipleV3Parameter, OEPricingMultipleV3Result>
{
    ...
    public void Execute_Should_Not_Get_BillTo_When_No_Pricing_Service_Parameters()
    {
        ...
        Assert.AreEqual(0, result.OEPricingMultipleV3Request.customerNumber);
    }
    ...
    public void Execute_Should_Throw_Exception_When_BillTo_Not_Found()
    {
        ...
        var parameter = this.CreateGetOEPricingMultipleV3Parameter(billTo.Id);
    ...
    public void Execute_Should_Get_BillTo()
    {
        ...
        Assert.AreEqual(
            decimal.Parse(billTo.ErpNumber),
            result.OEPricingMultipleV3Request.customerNumber
        );
    }

    protected OEPricingMultipleV3Parameter CreateGetOEPricingMultipleV3Parameter(Guid? billToId)
    {
