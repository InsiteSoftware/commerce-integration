    ...
    : BaseForPipeTests<SFOEOrderTotLoadV4Parameter, SFOEOrderTotLoadV4Result>
{
    ...
    public void Execute_Should_Return_Error_When_SFOEOrderTotLoadV4_Returns_Error()
    {
        ...
        var sFOEOrderTotLoadV4Response = new SFOEOrderTotLoadV4Response { ErrorMessage = "ABC123" };
        ...
        Assert.AreEqual(result.Message, sFOEOrderTotLoadV4Response.ErrorMessage);
