    ...
    : BaseForPipeTests<OEPricingMultipleV4Parameter, OEPricingMultipleV4Result>
{
    ...
    public void Execute_Should_Get_Inproduct3_Collection_With_PricingServiceParameters_Products()
    {
        ...
        this.VerifyOePricingMultipleV4RequestInProduct3Created(
    ...
    protected void VerifyOePricingMultipleV4RequestInProduct3Created(
    ...
    {
        Assert.IsTrue(
            oePricingMultipleV4Request.Inproduct.Any(
                o =>
