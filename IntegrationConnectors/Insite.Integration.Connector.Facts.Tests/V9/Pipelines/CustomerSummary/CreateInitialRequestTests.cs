    ...
    : BaseForPipeTests<CustomerSummaryParameter, CustomerSummaryResult>
{
    ...
    public void Execute_Should_Populate_Initial_Request()
    {
        ...
        Assert.IsNotNull(result.CustomerSummaryRequest);
        Assert.IsNotNull(result.CustomerSummaryRequest.Request);
        Assert.AreEqual("CustomerSummary", result.CustomerSummaryRequest.Request.RequestID);
    }
}
